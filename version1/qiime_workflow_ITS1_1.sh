...
cat fasta_ITS/*_ITS1.fasta > fasta_ITS/ITS.fna
parallel_pick_otus_blast.py -i fasta_ITS/ITS.fna  -b /common/genomics-core/reference/Microbiome/THFv1.61.sort.fasta -O 120 -o otus_THFv1.61
