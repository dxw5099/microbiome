...
/common/genomics-core/anaconda2/bin/cutadapt -a CTTGGTCATTTAGAGGAAGTAA...GCATCGATGAAGAACGCAGC  -A GCTGCGTTCTTCATCGATGC...TTACTTCCTCTAAATGACCAAG  --discard-untrimmed -o ./ITS_temp/$1_R1_ITS1.fastq.gz -p ./ITS_temp/$1_R2_ITS1.fastq.gz  $1_S*_R1_001.fastq.gz $1_S*_R2_001.fastq.gz >./ITS_temp/$1_ITS1.log
