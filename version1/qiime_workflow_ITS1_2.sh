...
##### Generate OTU table #####
make_otu_table.py -i otus_THFv1.62/$1_otus.txt -o $1_table.biom -t /home/genomics/genomics/reference/Microbiome/THFv1.62.sort.taxonomy
#/common/genomics-core/anaconda2/envs/qiime1/bin/make_otu_table.py -i otus_gg_13_5_97/$1_otus.txt -o $1_table.biom -t /home/genomics/genomics/reference/Microbiome/gg_13_5_97_otus.taxonomy
##### Convert into TXT format #####
biom convert -i $1_table.biom -o $1_table_THFv1.62.txt  --to-tsv --header-key="taxonomy"
#/common/genomics-core/anaconda2/envs/qiime1/bin/biom convert -i $1_table.biom -o $1_table_gg.txt  --to-tsv --header-key="taxonomy"
...
echo "Subject: ITS_processing is done" | sendmail -v di.wu@cshs.org
##### Extra manipulations #####
