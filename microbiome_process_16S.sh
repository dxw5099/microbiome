...
/common/genomics-core/anaconda2/bin/cutadapt -a AGAGTTTGATCMTGGCTCAG...TACGGRAGGCAGCAG  -A CTGCTGCCTYCCGTA...CTGAGCCAKGATCAAACTCT --discard-untrimmed -o ./16S_temp/$1_R1_16S.fastq.gz -p ./16S_temp/$1_R2_16S.fastq.gz  $1_R1_001.fastq.gz $1_R2_001.fastq.gz >./16S_temp/$1_16S.log
